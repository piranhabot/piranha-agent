...
class TestLLMProvider:
    ...
    def test_chat_sync(self):
        ...
        with patch('piranha_agent.llm_provider.completion') as mock_completion:
            ...
            with patch('piranha_agent.llm_provider.litellm.cost_calculator.completion_cost', return_value=0.001):
    ...
    def test_chat_streaming(self):
        ...
        with patch('piranha_agent.llm_provider.completion', return_value=mock_chunk_generator()):
    ...
    async def test_chat_async(self):
        ...
        with patch('piranha_agent.llm_provider.acompletion', new_callable=AsyncMock) as mock_acompletion:
            ...
            with patch('piranha_agent.llm_provider.litellm.cost_calculator.completion_cost', return_value=0.002):
    ...
    async def test_chat_async_streaming(self):
        ...
        with patch('piranha_agent.llm_provider.acompletion', return_value=mock_async_generator()):
    ...
    def test_chat_error_handling(self):
        ...
        with patch('piranha_agent.llm_provider.completion', side_effect=Exception("API Error")):
    ...
    async def test_chat_async_error_handling(self):
        ...
        with patch('piranha_agent.llm_provider.acompletion', new_callable=AsyncMock, side_effect=Exception("API Error")):
            with pytest.raises(Exception):
...
class TestLLMProviderIntegration:
    ...
    def test_cost_calculation_accuracy(self):
        ...
        with patch('piranha_agent.llm_provider.completion') as mock_completion:
            ...
            # Mock specific cost
            with patch('piranha_agent.llm_provider.litellm.cost_calculator.completion_cost', return_value=0.012):
                response = provider.chat(messages)
    ...
    def test_empty_response_handling(self):
        ...
        with patch('piranha_agent.llm_provider.completion') as mock_completion:
            ...
            with patch('piranha_agent.llm_provider.litellm.cost_calculator.completion_cost', return_value=0.0):
                response = provider.chat(messages)
    ...
    def test_long_response_handling(self):
        ...
        with patch('piranha_agent.llm_provider.completion') as mock_completion:
            ...
            with patch('piranha_agent.llm_provider.litellm.cost_calculator.completion_cost', return_value=0.1):
                response = provider.chat(messages)
